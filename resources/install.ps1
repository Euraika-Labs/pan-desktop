<#
==============================================================================
VENDORED BY PAN DESKTOP

  Source : https://github.com/NousResearch/hermes-agent/blob/main/scripts/install.ps1
  Fetched: 2026-04-11
  Commit : 79aeaa97e6d3b5065e10231e1733d656ab40f7a7
           (fix: re-order providers,Quick Install, subscription polling,
            2026-04-02T21:43:41Z)

  Reason for vendoring:
    Pan Desktop ships this PowerShell installer inside its own app bundle
    and runs it directly from `resources/install.ps1` at install time
    instead of fetching it over the network. This gives us supply chain
    isolation: the Pan Desktop installer is a single reviewed artifact and
    no code runs on a user machine that we did not check into git.

  Upgrade policy:
    When a new upstream version is needed, re-fetch the file, update the
    SHA + date above, verify the diff against upstream, and ship a new
    Pan Desktop release. Do NOT edit this file in place — any local patches
    should be documented here and reviewed against the upstream history.
==============================================================================
#>
